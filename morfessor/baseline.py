...
class Encoding(object):
    ...
    def frequency_distribution_cost(self): #LEXICON DISTRIBUTION
...
class CorpusEncoding(Encoding):
    ...
    def get_cost(self):
        ...
        return ((n * math.log(n)
                 - self.boundaries * math.log(self.boundaries)
                 - self.logtokensum) #* self.weight change made by Duygu: March 9, 2017. comment weight.
                + self.frequency_distribution_cost())
